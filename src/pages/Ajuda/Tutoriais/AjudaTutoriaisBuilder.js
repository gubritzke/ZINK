...
export default function AjudaTutoriaisBuilder(){
    ...
    useEffect(() => {
        ...
        async function getTutoriaisEbook(){       
            let list = await api.get('/tutoriais?produto=builder&tipo=ebook');
            setTutoriaisEbook(list.data);
        }
        getTutoriaisEbook();

        async function getTutoriaisVideo(){       
            let list = await api.get('/tutoriais?produto=builder&tipo=video');
