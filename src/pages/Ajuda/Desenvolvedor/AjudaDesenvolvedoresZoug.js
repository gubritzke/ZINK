...
export default function AjudaDesenvolvedoresZoug(){
    ...
    useEffect(() => {
        ...
        async function getDesenvolvedoresDoc(){       
            let list = await api.get('/desenvolvedores?produto=zoug&tipo=documentacao');
            setDesenvolvedoresDoc(list.data);
        }
        getDesenvolvedoresDoc();

        async function getDesenvolvedoresRel(){       
            let list = await api.get('/desenvolvedores?produto=zoug&tipo=releases');
