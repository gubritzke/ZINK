...
export default function AjudaDesenvolvedoresSms(){
    ...
    useEffect(() => {
        ...
        async function getDesenvolvedoresDoc(){       
            let list = await api.get('/desenvolvedores?produto=sms&tipo=documentacao');
            setDesenvolvedoresDoc(list.data);
        }
        getDesenvolvedoresDoc();

        async function getDesenvolvedoresRel(){       
            let list = await api.get('/desenvolvedores?produto=sms&tipo=releases');
